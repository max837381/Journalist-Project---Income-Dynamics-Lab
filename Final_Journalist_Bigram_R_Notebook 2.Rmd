...
library(pacman)
p_load(tidyverse, data.table, tm, quanteda, SnowballC, tokenizers, daff, tidytext, tictoc, readtext, gamlr, textir, usethis, Matrix)
...
txt_files_ls <- tail(list.files(path=mypath, pattern="*.txt"),1)
...
txt_files_ls <- tail(list.files(path="/Users/max/Desktop/Journalist Project - Income Dynamics Lab/hein-daily/", pattern="SpeakerMap.txt"),1)
